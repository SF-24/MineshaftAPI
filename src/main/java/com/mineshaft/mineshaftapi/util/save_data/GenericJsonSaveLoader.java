...
public class GenericJsonSaveLoader {

    private final Class<?> clazz;
    String path;
    String fileName;

    public GenericJsonSaveLoader(String path, String fileName, Class<?> clazz) {
    ...
    private void initiateFile() throws Exception {

        String path = MineshaftApi.getPluginDataPath();
    ...
    public static File getFile(String path, String fileName, Class<?> clazz) {
    ...
    public JsonSaveObject loadData() {
        File file = getFile(path,fileName,clazz);
        Gson gson = new Gson();
        Reader reader = null;
    ...
    public void saveFile(JsonSaveObject data) {
        writeData(data, getFile(path,fileName,clazz));
    }
